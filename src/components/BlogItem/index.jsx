    ...
    <div className="blogItem group">
      <Link href={`/blog/${props?.item?._id}`}>
        <div className="imgWrapper w-full overflow-hidden rounded-md cursor-pointer relative">
          <LazyLoadImage
            ...
            placeholderSrc="/blogPlaeholder.jpg"
          />
      ...
      <div className="info py-4">
        <h2 className="text-[15px] font-[600] text-black mb-1  lg:mb-3">
          <Link href={`/blog/${props?.item?._id}`} className="link">{props?.item?.title}</Link>
        </h2>
        ...
        <Link href={`/blog/${props?.item?._id}`} className="link font-[500] text-[14px] flex items-center gap-1">Read More <IoIosArrowForward /></Link>
