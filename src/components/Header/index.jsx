    ...
    <header className="fixed bg-white lg:sticky left-0 w-full top-0 z-[101] py-3">
      <div className="container">
        <div className="flex items-center justify-between">
          ...
          {/* nav items -------------------------------------------- */}
          <nav className={`flex items-center justify-center m-auto w-[60%] gap-4 transition-all ${isOpenNav === true && 'open'}`}>

            <Link href="/" className="w-[140px] block lg:hidden mb-5"  onClick={() => setIsOpenNav(false)}>
              <Image
                src={logo}
                alt="Soouqna Seller"
                width={140}
          ...
          <div className={`nav-overlay w-full h-full fixed top-0 left-0 z-[100] bg-[rgba(0,0,0,0.6)]  ${isOpenNav === true ? 'show' : 'hidden'}`}
            onClick={() => setIsOpenNav(false)}></div>
          ...
          <div className="relative mr-0 lg:mr-5 flex items-center gap-5">
            ...
            {
              context?.windowWidth < 992 && <IoMenu size={35} onClick={toggleNav} />
            }
